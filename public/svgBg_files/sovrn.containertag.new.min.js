...
module$dist$src$shared$url.urlCheck=urlCheck$$module$dist$src$shared$url;var buildConfig$$module$dist$src$ads$buildConfig={code_version:"1.65",beacon_url:"https://gslbeacon.lijit.com/beacon",adserver_url:"https://ap.lijit.com/addelivery",error_url:"https://ap.lijit.com/data/errors",config_url:"https://ap.lijit.com/adcfg",cookie_domain:".lijit.com",adserver_base:"https://ap.lijit.com",webserver_base:"https://www.lijit.com",impression_suffix:"/addelivery/impression",ad_timing_suffix:"/data/fp",adcenter_base:"https://adcenter.lijit.com/",lg_suffix:"/addelivery/impression",
...
d.join(", ")+" / Script Tags: "+c.join(", "));logToServer$$module$dist$src$impressionContainer$logToServer()}var module$dist$src$impressionContainer$tags={};module$dist$src$impressionContainer$tags.fireTags=fireTags$$module$dist$src$impressionContainer$tags;function exposeVars$$module$dist$src$impressionContainer$exposeVars(){window.sovrn=window.sovrn||{};window.sovrn.ct=window.sovrn.ct||{};window.sovrn.ct.fireTags=fireTags$$module$dist$src$impressionContainer$tags;window.sovrn.containerTag=window.sovrn.ct;window.sovrn.auction=window.sovrn.ct}var module$dist$src$impressionContainer$exposeVars={};module$dist$src$impressionContainer$exposeVars.exposeVars=exposeVars$$module$dist$src$impressionContainer$exposeVars;var cmpVersion$$module$dist$src$shared$consent;function doNotTrack$$module$dist$src$shared$consent(a,b){a=a||navigator;b=b||window;var c=readCookie$$module$dist$src$shared$dom("tracking_optout");return"yes"===a.doNotTrack||"1"===a.doNotTrack||"1"===a.msDoNotTrack||"1"===b.doNotTrack||"1"===c}
function lookupCcpaConsent$$module$dist$src$shared$consent(a,b){var c={uspData:"",success:!1},d=function(d,e){c.uspData=d&&d.uspString||"";(c.success=e)?a(c):b()};try{var e=window.__uspapi||window.top.__uspapi}catch(h){b(h)}if("function"===typeof e)e("getUSPData",1,d);else{e=window;for(var f,g=(new Date).getTime();!f;){try{e.frames.__uspapiLocator&&(f=e)}catch(h){b(h);return}if(e===window.top){b();return}e=e.parent}f.postMessage({__uspapiCall:{command:"getUSPData",version:1,parameter:null,callId:g}},
"*");window.addEventListener("message",function(c){c.data&&c.data.__uspapiReturn&&c.data.__uspapiReturn.callId===g&&(c.data.__uspapiReturn.success?a(c.data.__uspapiReturn.returnValue):b())},!1)}}function callCmpFromSafeframe$$module$dist$src$shared$consent(a,b,c,d){window.$sf.ext.register(1,1,function(a,f){"cmpReturn"===a?c(f[b]):d()});window.$sf.ext.cmp(a)}
function callCmpWhileInIframe$$module$dist$src$shared$consent(a,b,c){var d=2===cmpVersion$$module$dist$src$shared$consent?"__tcfapi":"__cmp",e={},f=Math.random().toString(),g=d+"Call",h={};h[g]={command:a,parameter:null,callId:f};1!==cmpVersion$$module$dist$src$shared$consent&&(h[g].version=cmpVersion$$module$dist$src$shared$consent);e[f]=c;b.postMessage(h,"*");window.addEventListener("message",function(a){var b=d+"Return",c={};try{c="string"===typeof a.data?JSON.parse(a.data):a.data}catch(l){}if(c[b]&&
c[b].callId&&(a=c[b],"function"===typeof e[a.callId]))e[a.callId](a.returnValue,a.success)},!1)}
function lookupGdprConsent$$module$dist$src$shared$consent(a,b){function c(c,d){d&&"string"===typeof c.tcString?"tcloaded"===c.eventStatus||"useractioncomplete"===c.eventStatus?a(c):"cmpuishown"===c.eventStatus&&0<c.tcString.length&&!0===c.purposeOneTreatment?a(c):b("Consent string is not available."):b("CMP unable to register callback function.  Please check CMP setup.")}var d=function(){function c(){d.getConsentData&&d.getVendorConsents?a(d):!d.hasOwnProperty("getConsentData")||!d.hasOwnProperty("getVendorConsents")||
d.getConsentData&&d.getVendorConsents||b("Consent string is blank.")}var d={};return{consentDataCallback:function(a){d.getConsentData=a;c()},vendorConsentsCallback:function(a){d.getVendorConsents=a;c()}}}(),e=function(){for(var a=window,b,c;!b;){try{if("function"===typeof a.__tcfapi||"function"===typeof a.__cmp){"function"===typeof a.__tcfapi?(cmpVersion$$module$dist$src$shared$consent=2,c=a.__tcfapi):(cmpVersion$$module$dist$src$shared$consent=1,c=a.__cmp);b=a;break}}catch(m){}try{if(a.frames.__tcfapiLocator){cmpVersion$$module$dist$src$shared$consent=
2;b=a;break}}catch(m){}try{if(a.frames.__cmpLocator){cmpVersion$$module$dist$src$shared$consent=1;b=a;break}}catch(m){}if(a===window.top)break;a=a.parent}return[b,c]}(),f=e[0];e=e[1];if(!f)return b("CMP not found.");"function"===typeof e?1===cmpVersion$$module$dist$src$shared$consent?(e("getConsentData",null,d.consentDataCallback),e("getVendorConsents",null,d.vendorConsentsCallback)):2===cmpVersion$$module$dist$src$shared$consent&&e("addEventListener",cmpVersion$$module$dist$src$shared$consent,c):
1===cmpVersion$$module$dist$src$shared$consent&&window.$sf&&window.$sf.ext&&"function"===typeof window.$sf.ext.cmp?(callCmpFromSafeframe$$module$dist$src$shared$consent("getConsentData",d.consentDataCallback,b),callCmpFromSafeframe$$module$dist$src$shared$consent("getVendorConsents",d.vendorConsentsCallback,b)):1===cmpVersion$$module$dist$src$shared$consent?(callCmpWhileInIframe$$module$dist$src$shared$consent("getConsentData",f,d.consentDataCallback),callCmpWhileInIframe$$module$dist$src$shared$consent("getVendorConsents",
f,d.vendorConsentsCallback)):2===cmpVersion$$module$dist$src$shared$consent&&callCmpWhileInIframe$$module$dist$src$shared$consent("addEventListener",f,c)}function configureCcpaConsent$$module$dist$src$shared$consent(a,b,c){a?lookupCcpaConsent$$module$dist$src$shared$consent(function(a){b.ccpa_consent=a.uspData;c()},function(a){b.ccpa_consent="notFound";c()}):c()}
function configureGdprAndCcpaConsent$$module$dist$src$shared$consent(a,b,c,d){a?lookupGdprConsent$$module$dist$src$shared$consent(function(a){c.gdpr_version=cmpVersion$$module$dist$src$shared$consent;c.gdpr_consent=1===cmpVersion$$module$dist$src$shared$consent?a.getConsentData.consentData:a.tcString;configureCcpaConsent$$module$dist$src$shared$consent(b,c,d)},function(){configureCcpaConsent$$module$dist$src$shared$consent(b,c,d)}):configureCcpaConsent$$module$dist$src$shared$consent(b,c,d)}
var module$dist$src$shared$consent={};module$dist$src$shared$consent.configureGdprAndCcpaConsent=configureGdprAndCcpaConsent$$module$dist$src$shared$consent;module$dist$src$shared$consent.doNotTrack=doNotTrack$$module$dist$src$shared$consent;function init$$module$dist$src$impressionContainer$init(){if(isOldIE$$module$dist$src$shared$dom())return log$$module$dist$src$impressionContainer$logging("Legacy IE detected; Aborting"),!1;log$$module$dist$src$impressionContainer$logging("Container Tag Start");var a=getScriptTag$$module$dist$src$shared$dom($jscompDefaultExport$$module$dist$src$impressionContainer$buildConfig.tag_regex);if(!a)return reportError$$module$dist$src$impressionContainer$logging("Could not find CT script tag",Error()),!1;
var b;a.id&&3<a.id.length&&(b=a.id.substring(3));$jscompDefaultExport$$module$dist$src$impressionContainer$config.addTransaction(b);$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.scriptTag=a;$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.query_params=parseQueryString$$module$dist$src$shared$url(a.src);$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.version=$jscompDefaultExport$$module$dist$src$impressionContainer$config.getQueryParam("v")||
"3";$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.us_privacy=$jscompDefaultExport$$module$dist$src$impressionContainer$config.getQueryParam("us_privacy");$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.container_id=$jscompDefaultExport$$module$dist$src$impressionContainer$config.getQueryParam("cid");$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.zone_id=$jscompDefaultExport$$module$dist$src$impressionContainer$config.getQueryParam("zid");
$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.gdpr_flag=$jscompDefaultExport$$module$dist$src$impressionContainer$config.getQueryParam("gdpr_flag");if(!$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.container_id)return reportError$$module$dist$src$impressionContainer$logging("Missing cid",Error()),!1;if(!$jscompDefaultExport$$module$dist$src$impressionContainer$config.ctInstance.zone_id)return reportError$$module$dist$src$impressionContainer$logging("Missing zid",
Error()),!1;exposeVars$$module$dist$src$impressionContainer$exposeVars();try{configureGdprAndCcpaConsent$$module$dist$src$shared$consent(!0,!0,$jscompDefaultExport$$module$dist$src$impressionContainer$config.getConfig(),getDataFromServer$$module$dist$src$impressionContainer$getDataFromServer)}catch(c){reportError$$module$dist$src$impressionContainer$logging("Consent Module Failure",c),getDataFromServer$$module$dist$src$impressionContainer$getDataFromServer()}}
var module$dist$src$impressionContainer$init={};module$dist$src$impressionContainer$init.init=init$$module$dist$src$impressionContainer$init;init$$module$dist$src$impressionContainer$init();var module$dist$src$impressionContainer$index={};
